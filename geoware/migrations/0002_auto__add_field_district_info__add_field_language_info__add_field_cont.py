...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'District.info'
        db.add_column('geoware-district', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Language.info'
        db.add_column('geoware-language', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Continent.info'
        db.add_column('geoware-continent', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Region.info'
        db.add_column('geoware-region', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Currency.info'
        db.add_column('geoware-currency', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Altname.ref_geoname_id'
        db.add_column('geoware-altname', 'ref_geoname_id',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'City.info'
        db.add_column('geoware-city', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Ocean.info'
        db.add_column('geoware-ocean', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Subregion.info'
        db.add_column('geoware-subregion', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Timezone.info'
        db.add_column('geoware-timezone', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Country.info'
        db.add_column('geoware-country', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'District.info'
        db.delete_column('geoware-district', 'info')

        # Deleting field 'Language.info'
        db.delete_column('geoware-language', 'info')

        # Deleting field 'Continent.info'
        db.delete_column('geoware-continent', 'info')

        # Deleting field 'Region.info'
        db.delete_column('geoware-region', 'info')

        # Deleting field 'Currency.info'
        db.delete_column('geoware-currency', 'info')

        # Deleting field 'Altname.ref_geoname_id'
        db.delete_column('geoware-altname', 'ref_geoname_id')

        # Deleting field 'City.info'
        db.delete_column('geoware-city', 'info')

        # Deleting field 'Ocean.info'
        db.delete_column('geoware-ocean', 'info')

        # Deleting field 'Subregion.info'
        db.delete_column('geoware-subregion', 'info')

        # Deleting field 'Timezone.info'
        db.delete_column('geoware-timezone', 'info')

        # Deleting field 'Country.info'
        db.delete_column('geoware-country', 'info')
