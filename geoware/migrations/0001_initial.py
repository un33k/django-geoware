# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-01-04 18:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(db_index=True, max_length=254, verbose_name='FIELDS.NAME')),
                ('slug', models.CharField(blank=True, max_length=254, null=True, verbose_name='LOCATION.SLUG')),
                ('name_std', models.CharField(blank=True, max_length=254, null=True, unique=True, verbose_name='LOCATION.NAME_STD.FIELD')),
